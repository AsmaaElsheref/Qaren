    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isUnread ? AppColors.primaryLight.withValues(alpha: 0.55) : AppColors.surface,
          borderRadius: BorderRadius.circular(AppDimensions.radiusL),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      AppText(notification.data.status.label, style: AppTextStyles.caption),
                      if (notification.createdAtLabel.isNotEmpty)
                        AppText(notification.createdAtLabel, style: AppTextStyles.caption),
                    ],
                  ),
                ],
              ),
